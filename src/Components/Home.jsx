      ...
      <section className="bottom">
        ...
        <section className="top-row">
          <section className="review">
            ...
            <p>
              Without him, {faker.company.name()} wouldn't be what is today!
            </p>
          </section>
          <section className="review">
            <h4>{faker.name.fullName()}</h4>
            ...
            <p>
              {faker.company.bs()} wouldn't be the {faker.word.adjective()}{" "}
              place it is today if I hadn't of met him.
            </p>
            <p>
        ...
        <section className="bot-row">
          <section className="review">
            ...
            <p>
              He saved my family from a {faker.animal.bear()} with his bare
              hands.
            </p>
            <p>
